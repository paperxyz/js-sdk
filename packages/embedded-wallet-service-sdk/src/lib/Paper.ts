...
export class PaperEmbeddedWalletSdk {
   ...
   * @param {CustomizationOptionsTypes} initParams.styles sets the default style override for any modal that pops up asking for user's details when creating wallet or logging in.
   */
